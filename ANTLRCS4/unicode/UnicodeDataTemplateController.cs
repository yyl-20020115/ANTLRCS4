...
public abstract class UnicodeDataTemplateController {
	private static void addIntervalForCategory(
			Dictionary<String, IntervalSet> categoryMap,
			String categoryName,
			int start,
			int finish) {
	...
	public static Dictionary<String, Object> getProperties() {
        Dictionary<String, IntervalSet> propertyCodePointRanges = new ();
	...
	private static void addUnicodeCategoryCodesToCodePointRanges(Dictionary<String, IntervalSet> propertyCodePointRanges) {
	...
	private static void addUnicodeCategoryCodesToNames(Dictionary<String, String> propertyAliases) {
		RangeValueIterator iter = UCharacter.getTypeIterator();
		RangeValueIterator.Element element = new RangeValueIterator.Element();
		while (iter.next(element)) {
	...
	private static void addUnicodeBinaryPropertyCodesToCodePointRanges(Dictionary<String, IntervalSet> propertyCodePointRanges) {
	...
	private static void addUnicodeBinaryPropertyCodesToNames(Dictionary<String, String> propertyAliases) {
		for (int property = UProperty.BINARY_START;
		     property < UProperty.BINARY_LIMIT;
		     property++) {
			String propertyName = getShortPropertyName(property);
	...
	private static void addIntPropertyRanges(int property, String namePrefix, Dictionary<String, IntervalSet> propertyCodePointRanges) {
	...
	private static void addUnicodeIntPropertyCodesToCodePointRanges(Dictionary<String, IntervalSet> propertyCodePointRanges) {
