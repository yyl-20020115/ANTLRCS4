// $ANTLR 3.5.3 org\\antlr\\v4\\parse\\ActionSplitter.g 2023-01-27 19:22:58
...
public class ActionSplitter : Lexer {
	...
	public static readonly int LINE_COMMENT=8;
	public static readonly int NONLOCAL_ATTR=9;
	public static readonly int QUALIFIED_ATTR=10;
	public static readonly int SET_ATTR=11;
	public static readonly int SET_NONLOCAL_ATTR=12;
	public static readonly int TEXT=13;
	public static readonly int WS=14;

	ActionSplitterListener @delegate;

	public ActionSplitter(CharStream input, ActionSplitterListener @delegate): this(input, new RecognizerSharedState())
    {
	...
	public ActionSplitter(CharStream input): this(input, new RecognizerSharedState())
    {
	}
	public ActionSplitter(CharStream input, RecognizerSharedState state): base(input, state)
    {
	}
	//@Override
		public String getGrammarFileName() { return "org\\antlr\\v4\\parse\\ActionSplitter.g"; }

	//@Override
	public Token nextToken() {
		while (true) {
			if ( input.LA(1)==CharStream.EOF ) {
				Token eof = new CommonToken(this.input,Token.EOF,
	...
	public void mSET_NONLOCAL_ATTR(){
		try {
			...
			x = new CommonToken(input, Token.INVALID_TYPE, Token.DEFAULT_CHANNEL, xStart115, getCharIndex()-1);
			...
			mID(); if (state.failed) return;
			y = new CommonToken(input, Token.INVALID_TYPE, Token.DEFAULT_CHANNEL, yStart121, getCharIndex()-1);
			...
			expr = new CommonToken(input, Token.INVALID_TYPE, Token.DEFAULT_CHANNEL, exprStart130, getCharIndex()-1);
	...
	public void mNONLOCAL_ATTR(){
		try {
			...
			mID(); if (state.failed) return;
			x = new CommonToken(input, Token.INVALID_TYPE, Token.DEFAULT_CHANNEL, xStart151, getCharIndex()-1);
			...
			mID(); if (state.failed) return;
			y = new CommonToken(input, Token.INVALID_TYPE, Token.DEFAULT_CHANNEL, yStart157, getCharIndex()-1);
	...
	public void mQUALIFIED_ATTR(){
		try {
			...
			mID(); if (state.failed) return;
			x = new CommonToken(input, Token.INVALID_TYPE, Token.DEFAULT_CHANNEL, xStart174, getCharIndex()-1);
			...
			mID(); if (state.failed) return;
			y = new CommonToken(input, Token.INVALID_TYPE, Token.DEFAULT_CHANNEL, yStart180, getCharIndex()-1);
	...
	public void mSET_ATTR(){
		try {
			...
			mID(); if (state.failed) return;
			x = new CommonToken(input, Token.INVALID_TYPE, Token.DEFAULT_CHANNEL, xStart199, getCharIndex()-1);
			...
			mATTR_VALUE_EXPR(); if (state.failed) return;
			expr = new CommonToken(input, Token.INVALID_TYPE, Token.DEFAULT_CHANNEL, exprStart208, getCharIndex()-1);
	...
	public void mATTR(){
		try {
			...
			mID(); if (state.failed) return;
			x = new CommonToken(input, Token.INVALID_TYPE, Token.DEFAULT_CHANNEL, xStart229, getCharIndex()-1);
