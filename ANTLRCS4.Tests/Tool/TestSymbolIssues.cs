...
public class TestSymbolIssues
{
    ...
    public void TestStringLiteralRedefs()
    {
        ...
        var g = new LexerGrammar(grammar);

        var expectedTokenIDToTypeMap = "{EOF=-1, A=1, B=2, C=3}";
        var expectedStringLiteralToTypeMap = "{}";
        var expectedTypeToTokenList = "[A, B, C]";
    ...
    [TestMethod]
    public void TestCaseInsensitiveCharsCollision()
    {
        string[] test = {
                "lexer grammar L;\n" +
    ...
    [TestMethod]
    public void TestIllegalCaseInsensitiveOptionValue()
    {
        string[] test = {
                "lexer grammar L;\n" +
    ...
    [TestMethod]
    public void TestRedundantCaseInsensitiveLexerRuleOption()
    {
        string[] test = {
                "lexer grammar L;\n" +
                "options { caseInsensitive = true; }\n" +
    ...
    [TestMethod]
    public void TestCaseInsensitiveOptionInParseRule()
    {
        string[] test = {
                "grammar G;\n" +
    ...
    [TestMethod]
    public void TestNotImpliedCharacters()
    {
        string[] test = {
                "lexer grammar Test;\n" +
                "TOKEN1: 'A'..'g';\n" +
    ...
    [TestMethod]
    public void TestNotImpliedCharactersWithCaseInsensitiveOption()
    {
        string[] test = {
                "lexer grammar Test;\n" +
                "options { caseInsensitive=true; }\n" +
