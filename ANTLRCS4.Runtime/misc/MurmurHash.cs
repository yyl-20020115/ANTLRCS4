...
public static class MurmurHash
{
	 ...
	 * @return the updated intermediate hash value
	 */
    public static int Update(int hash, object value) => Update(hash, value != null ? value.GetHashCode() : 0);
	 ...
	 */
    public static int GetHashCode<T>(T[] data, int seed) where T: notnull
    {
